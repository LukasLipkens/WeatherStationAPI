...
namespace WeatherStationAPI.Migrations
{
    ...
    [Migration("20241009153745_PC-Lukas")]
    partial class PCLukas
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WeatherStationAPI.Models.Measurement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            StationId = 1,
                            SensorId = 1,
                            Timestamp = new DateTime(2024, 10, 8, 15, 37, 44, 806, DateTimeKind.Utc).AddTicks(8088),
                            Value = 23.5
                        },
                        new
                        {
                            StationId = 1,
                            SensorId = 2,
                            Timestamp = new DateTime(2024, 10, 8, 15, 37, 44, 806, DateTimeKind.Utc).AddTicks(8093),
                            Value = 60.0
                        },
                        new
                        {
                            StationId = 2,
                            SensorId = 1,
                            Timestamp = new DateTime(2024, 10, 9, 9, 37, 44, 806, DateTimeKind.Utc).AddTicks(8094),
