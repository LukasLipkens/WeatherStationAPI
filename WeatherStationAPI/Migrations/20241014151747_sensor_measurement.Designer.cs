...
namespace WeatherStationAPI.Migrations
{
    ...
    [Migration("20241014151747_sensor_measurement")]
    partial class sensor_measurement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WeatherStationAPI.Models.Measurement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            StationId = 1,
                            SensorId = 1,
                            Timestamp = new DateTime(2024, 10, 13, 15, 17, 47, 360, DateTimeKind.Utc).AddTicks(7608),
                            Value = 23.5
                        },
                        new
                        {
                            StationId = 1,
                            SensorId = 2,
                            Timestamp = new DateTime(2024, 10, 13, 15, 17, 47, 360, DateTimeKind.Utc).AddTicks(7612),
                            Value = 60.0
                        },
                        new
                        {
                            StationId = 2,
                            SensorId = 1,
                            Timestamp = new DateTime(2024, 10, 14, 9, 17, 47, 360, DateTimeKind.Utc).AddTicks(7613),
